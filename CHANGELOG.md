...
- **Einstellungsseite mit Suche:** Konto-Übersicht (Name, Nutzer-ID, Sprache),
  automatische Synchronisierung an/aus, Start mit Dashboard an/aus und
  Cache leeren – alles durchsuchbar.
- **Update-Prüfung:** Die App erkennt beim Start und auf Knopfdruck, ob eine neue
  Version verfügbar ist, und zeigt installierte und neueste Version im neuen
  Bereich „Aktualisierungen" an.
...
- **„Soon"- und „Beta"-Kennzeichnung:** Noch nicht verfügbare Bereiche (Noten,
  ...
  „Soon" markiert und zeigen beim Klick einen Hinweis, statt still nichts zu tun.
...
- **Echte Daten statt Platzhalter:** In der Sidebar steht jetzt der Name aus dem
  Canvas-Konto statt Beispieldaten; erfundene Zähler und Hinweispunkte an
